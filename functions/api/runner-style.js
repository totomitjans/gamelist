...
export function runnerStyle({ maxWidth = "980px", settings = {}, page = "gamelist" } = {}) {
  ...
  return `<style>
    ...
    *{box-sizing:border-box}
    ...
    .runner-platform-button{display:grid;grid-template-columns:minmax(0,1fr);align-items:center;height:42px;min-height:42px;padding:0 34px 0 11px;background:url("data:image/svg+xml,%3Csvg width='14' height='14' viewBox='0 0 14 14' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M3.5 5.25 7 8.75l3.5-3.5' fill='none' stroke='%23f6f7fb' stroke-opacity='.78' stroke-width='1.7' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E") right 15px center/14px 14px no-repeat,#1e2530;border:1px solid #3d4655;border-radius:7px;cursor:pointer}
    .runner-platform-button:hover,.runner-platform-button:focus-visible,.runner-platform-select.is-open .runner-platform-button{border-color:#526075;box-shadow:none;outline:none}
    .runner-platform-menu{position:absolute;left:0;right:auto;top:calc(100% + 6px);z-index:21;display:none;width:max-content;min-width:min(100%,150px);max-width:min(320px,calc(100vw - 32px));max-height:380px;padding:3px;overflow:auto;background:#1e2530;border:1px solid #3d4655;border-radius:8px;box-shadow:0 18px 44px rgba(0,0,0,.42)}
    ...
    .runner-platform-option:hover,.runner-platform-option:focus-visible,.runner-platform-option.is-selected{color:#fff;background:#263142;border-color:#526075;outline:none}
