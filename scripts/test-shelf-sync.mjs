...
assert.match(collectionPriceSource, /idCandidate \|\| exactCandidate \|\| broadExactCandidate \|\| bestCandidate\(candidates, query\)/, "PriceCharting public fallback must still use ranked physical title matching when the free public site cannot resolve a saved ID");
